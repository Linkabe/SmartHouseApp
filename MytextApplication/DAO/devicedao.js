...
var devicedao={
    ...
    sqlInsert: "insert into devicetable (Device, DStatus) values (?,?);",
    // sqlInsertAi: "insert into ai_tbl (Devices, DStatus) values (?,?);",
    sqlUpdateLon: "update devicetable set DStatus = 'On' where ID = 1;",
    sqlUpdateLoff: "update devicetable set DStatus = 'Off' where ID = 1;",
    sqlUpdateHon: "update devicetable set DStatus = 'On' where ID = 2;",
    sqlUpdateHoff: "update devicetable set DStatus = 'Off' where ID = 2;",
    sqlUpdateTon: "update devicetable set DStatus = 'On' where ID = 8;",
    sqlUpdateToff: "update devicetable set DStatus = 'Off' where ID = 8;",
