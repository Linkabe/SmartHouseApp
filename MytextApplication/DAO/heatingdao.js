...
var heatingdao;
heatingdao = {
    sqlGetAll: "Select HHouseTemp, HHHumidity,Date, DStatus from heating_tbl, devicetable WHERE devicetable.ID='2' or Date > DATE_SUB(NOW(), INTERVAL 1 DAY);",
    sqlGetAllVals: "Select HHouseTemp from heating_tbl WHERE Date > DATE_SUB(NOW(), INTERVAL 1 DAY);",
    sqlFindById: "select * from heating_tbl where ID = ?;",
    sqlInsert: "insert into heating_tbl (HHouseTemp, HHHumidity, HStatus) values (?,?,?);",
    sqlUpdateHon: "update devicetable set DStatus = 'On' where ID = 2;",
    sqlUpdateHoff: "update devicetable set DStatus = 'Off' where ID = 2;",
